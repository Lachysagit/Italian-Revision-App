...
public:
    ...
    //old default constructor could not be given one
...
private:
    ...
    //read once from <model_path>.json at construction, because piper takes the
    //rate from the voice's own config. 22050 is piper's own fallback
};
